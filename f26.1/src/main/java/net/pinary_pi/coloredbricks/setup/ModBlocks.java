...
*/
    ...
    private static void addBlocksToBuildingBlocksTab(FabricCreativeModeTabOutput entries) {
        // Normal Brick Blocks
    ...
    private static void addBlocksToFunctionalBlocksTab(FabricCreativeModeTabOutput entries) {
        // Flower Pots
/*
...
*/
    ...
    private static void addBlocksToColoredBlocksTab(FabricCreativeModeTabOutput entries) {
        // Normal Brick Blocks
        entries.add(WHITE_BRICKS);
        entries.add(ORANGE_BRICKS);
        entries.add(PINK_BRICKS);
...
*/
    ...
    public static void registerModBlocks() {
        ColoredBricks.LOGGER.info("Registering blocks for " + ColoredBricks.MOD_ID);

        CreativeModeTabEvents.modifyOutputEvent(ItemGroups.BUILDING_BLOCKS).register(ModBlocks::addBlocksToBuildingBlocksTab);
        CreativeModeTabEvents.modifyOutputEvent(ItemGroups.FUNCTIONAL).register(ModBlocks::addBlocksToFunctionalBlocksTab);
        CreativeModeTabEvents.modifyOutputEvent(ItemGroups.COLORED_BLOCKS).register(ModBlocks::addBlocksToColoredBlocksTab);

/*
        ColoredBricks.LOGGER.info("Registering potted plants for coloredbricks");
