...
public class ModItems {
    ...
    private static void addItemsToIngredientTab(FabricCreativeModeTabOutput entries) {
    ...
    public static void registerModItems() {
        ColoredBricks.LOGGER.info("Registering items for " + ColoredBricks.MOD_ID);

        CreativeModeTabEvents.modifyOutputEvent(ItemGroups.INGREDIENTS).register(ModItems::addItemsToIngredientTab);
    }
}
